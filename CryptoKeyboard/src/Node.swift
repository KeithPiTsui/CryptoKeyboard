...
func stringUnlessNil(_ p: UnsafePointer<Int8>?) -> String? {
    return p == nil ? nil : String(validatingUTF8: p!)
}
...
extension OpaquePointer {
    func mapIfNonNil<U>(_ transform: (OpaquePointer)->U) -> U? {
        if self == nil {
            return nil
        } else {
